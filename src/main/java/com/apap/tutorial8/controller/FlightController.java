...
public class FlightController {
    ...
    FlightModel view(@RequestParam(value = "flightNumber") String flightNumber, Model model) {
    ...
    private @ResponseBody
    FlightModel updateFlightSubmit(@ModelAttribute FlightModel flight, Model model) {
        flightService.addFlight(flight);
        return flight;
    }
}